...
window.onload = function(){
    ...
    // initialize();
    c1 = document.getElementById("scratchLayer");
...
function eventMove(e){
    ...
    if(ismousedown) {
        ...
        var topY = document.getElementById("ScratchPrize").offsetTop;
    ...
    if(isOk){
        var btn = document.getElementsByClassName("line");
        for(var i=0; i<btn.length; i++){
            btn[i].style.zIndex = '3';
        }
        document.getElementsByClassName("line")[0].style.zIndex="3";
    }
}
